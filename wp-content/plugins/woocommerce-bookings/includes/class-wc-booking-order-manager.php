			...
			foreach ( $booking_ids as $booking_id ) {
				...
				<div class="wc-booking-summary">
					<strong class="wc-booking-summary-number">
						<?php printf( __( 'Réservation #%s', 'woocommerce-bookings' ), esc_html( $booking->get_id() ) ); ?>
					...
					<div class="wc-booking-summary-actions">
						<?php if ( $booking_id && function_exists( 'wc_get_endpoint_url' ) && wc_get_page_id( 'myaccount' ) ) : ?>
							<a href="<?php echo esc_url( wc_get_endpoint_url( $this->get_endpoint(), '', wc_get_page_permalink( 'myaccount' ) ) ); ?>">Voir mes réservations &rarr;</a>
						<?php endif; ?>
					</div>
				</div>
				<?php
