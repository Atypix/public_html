jQuery(document).ready(function($) {
	...
	$('.wc-bookings-booking-form')
		.on('change', 'input, select', function( e ) {
			...
			$('.wc-bookings-booking-cost').empty();
			$form.find('.wc-bookings-booking-cost').block({message: "<img src='https://www.mylittlewe.com/wp-content/themes/knowherepro/images/ajax-loader.gif'/>", overlayCSS: {textAlign : 'center', background: '#fff', backgroundSize: '16px 16px', opacity: 1}}).show();
