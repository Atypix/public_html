...
class MAD_Post_Field extends MAD_Object_Choice_Field {
	...
	public static function normalize( $field ) {
		...
		if ( empty( $field['placeholder'] ) ) {
			$field['placeholder'] = esc_html__( 'Select a post', 'knowherepro_app_textdomain' );
			if ( is_string( $field['query_args']['post_type'] ) && post_type_exists( $field['query_args']['post_type'] ) ) {
				...
				$field['placeholder'] = sprintf( __( 'Select a %s', 'knowherepro_app_textdomain' ), $post_type_object->labels->singular_name );
			}
		}
