	...
	function new_message_form( $atts, $content = null, $tag = '' ){
		$atts = shortcode_atts( array(
			...
			if( ! is_user_logged_in() ){
				...
				return apply_filters( 'fep_filter_shortcode_new_message_form', "<div class='fep-error'>".sprintf(__('Vous ne pouvez pas vous envoyer un message, %s ;)', 'front-end-pm'), fep_user_name( $to_id ) )."</div>", $atts );
			}
