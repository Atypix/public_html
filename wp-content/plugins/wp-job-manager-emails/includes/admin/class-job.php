...
class WP_Job_Manager_Emails_Admin_Job extends WP_Job_Manager_Emails_Admin {

	/**
	 * WP_Job_Manager_Emails_Job_Admin constructor.
	 *
	 * @param $cpt WP_Job_Manager_Emails_Job
	 */
	public function __construct( $cpt ) {

		$this->cpt       = $cpt;
		$this->help      = new WP_Job_Manager_Emails_Admin_Help_Job( $cpt );
		$this->ajax      = new WP_Job_Manager_Emails_Admin_Ajax_Job( $cpt );
		$this->settings  = new WP_Job_Manager_Emails_Admin_Settings_Job( $cpt );
		$this->listtable = new WP_Job_Manager_Emails_Admin_ListTable_Job( $cpt );
	...
	function init_pointers() {
		...
		$pointers = array(
			array(
				'id'       => 'jm-job-emails-template-default-tab',
				'screen'   => 'jm_job_emails',
			...
			array(
				'id'       => 'jm-job-emails-sc-tab-pointer',
				'screen'   => 'jm_job_emails',
			...
			array(
				'id'       => 'jm-job-emails-templates-pointer',
				'screen'   => 'jm_job_emails',
			...
			array(
				'id'       => 'jm-job-emails-menu-item',
				'screen'   => 'all',
				'target'   => '#menu-posts-job_listing',
				'title'    => __( 'Email Templates', 'wp-job-manager-emails' ),
				'content'  => __( 'You can find the <strong>Email</strong> sub-menu item under each parent menu item that supports Email Templates for WP Job Manager.', 'wp-job-manager-emails' ),
				'position' => array(
