...
class Webtoffee_Wordpress_Migrator
{
     ...
     * @since    1.0.0
     * @access   protected
     * @var      Webtoffee_Wordpress_Migrator_Loader $loader Maintains and registers all hooks for the plugin.
     */
    protected $loader;
     ...
     *
     * - Webtoffee_Wordpress_Migrator_Loader. Orchestrates the hooks of the plugin.
     * - Webtoffee_Wordpress_Migrator_i18n. Defines internationalization functionality.
     * - Webtoffee_Wordpress_Migrator_Admin. Defines all hooks for the admin area.
     * - Webtoffee_Wordpress_Migrator_Public. Defines all hooks for the public side of the site.
     *
     ...
     *
     * Uses the Webtoffee_Wordpress_Migrator_i18n class in order to set the domain and to register the hook
     * with WordPress.
     *
     * @since    1.0.0
     * @access   private
     ...
     *
     * @since     1.0.0
     * @return    Webtoffee_Wordpress_Migrator_Loader    Orchestrates the hooks of the plugin.
     */
