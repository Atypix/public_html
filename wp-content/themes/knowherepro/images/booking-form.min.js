jQuery(document).ready(function($) {
	...
	$('.wc-bookings-booking-form')
		.on('change', 'input, select', function( e ) {
			...
			$form.find('.wc-bookings-booking-cost').block({message: "<div style='width:100%' class='wc-bookings-booking-cost'><img src='https://www.http://mylittlewe.com//wp-content/themes/knowherepro/images/ajax-loader.gif'/></div>", overlayCSS: {background: '#fff', backgroundSize: '16px 16px', opacity: 0.6}}).show();
			xhr[index] = $.ajax({
				type: 		'POST',
